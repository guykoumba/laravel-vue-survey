<template>
  <PageComponent>
    ...
    <form v-else="!surveyLoadin" @submit.prevent="saveSurvey">
      <div class="shadow sm:rounded-md sm:overflow-hidden">
        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
          ...
          <div>
            ...
            <textarea type="text" name="description" id="description" rows="3" v-model="model.description"
          ...
          <div>
            ...
            <input type="date" name="expire_date" id="expire_date" v-model="model.expire_date"
              autocomplete="survey_title" class="
                mt-1
                focus:ring-indigo-500 focus:border-indigo-500
                block
                w-full
